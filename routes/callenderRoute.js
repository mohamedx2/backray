...
const {verifyAdminToken,verifyToken} = require('../middlewares/verifyToken'); // Adjust this path as necessary
...
router.get('/user',verifyToken, calendarController.getCalendarsByUser);
